...
std::ostream& operator<<(std::ostream &os, const Skin &s){
	os << "[name:" << s._name << ", price:" << s._price << ", texture:" << s._texture << ", previewPng:" << s._previewPng <<"]";
	return os;
}
